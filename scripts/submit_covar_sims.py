...
parser = argparse.\
    ArgumentParser(description='Submit all simulations for covariance estimation with block diagiaonal shrinkage.')
...
submit_multiple_sims(args=args, model_name='covar',
                     base_options=[],
