...
# setup configuration
parser = argparse.ArgumentParser(description='Run a single simulation for block diagonal logistic regression.')
...
parser.add_argument('--add_ridge', action='store_true', default=False,
                    help='Use a ridge penalty.')

args = parser.parse_args()
maybe_submit_on_bayes(args)

# run the simulation!
run_sim_from_args(args, model_name='log_reg', verbosity=np.inf)
